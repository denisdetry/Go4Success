...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    noma = models.CharField(
        db_column='NOMA', max_length=8, blank=True, null=True)
    ...
    date_join = models.DateTimeField(
        default=timezone.now, db_column='DATE_JOIN')
    last_login = models.DateTimeField(
        blank=True, null=True, db_column='LAST_LOGIN')
...
class ACTIVITY(models.Model):
    ...
    activty_course_code = models.ForeignKey(
        COURSE, on_delete=models.CASCADE, db_column='ACTIVITY_COURSE_CODE', max_length=9,
...
class ANNOUNCEMENT(models.Model):
    ...
    announcement_course_code = models.OneToOneField(
        COURSE, on_delete=models.CASCADE, db_column='ANNOUNCEMENT_COURSE_CODE',
...
class MESSAGE(models.Model):
    ...
    message_to_user_id = models.OneToOneField(User, on_delete=models.CASCADE,
                                              db_column='MESSAGE_TO_USER_ID',
                                              max_length=8, blank=True, null=True,
                                              related_name='message_to_user_id')
    message_from_user_id = models.OneToOneField(
        User, on_delete=models.CASCADE, db_column='MESSAGE_FROM_USER_ID',
        max_length=8, blank=True, null=True, related_name='message_from_user_id')
...
class SEES(models.Model):
    announcement_id = models.OneToOneField(
        # primary_key=True
        ANNOUNCEMENT, on_delete=models.CASCADE, db_column='ANNOUNCEMENT_ID')
