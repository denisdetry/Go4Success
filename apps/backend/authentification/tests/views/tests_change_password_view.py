...
class ChangePasswordViewTest(APITestCase):
    ...
    def test_change_password_ok(self):
        ...
        response = self.client.put(reverse("change_password", kwargs={'id': self.user.id}), data)
    ...
    def test_change_password_wrong_old_password(self):
        ...
        self.assertEqual(response.data["old_password"], {"old_password": "L'ancien mot de passe est incorrect"})
    ...
    def test_change_password_no_old_password(self):
        ...
        response = self.client.put(reverse("change_password", kwargs={'id': self.user.id}), data)
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.data["old_password"], ["This field is required."])
    ...
    def test_change_password_no_user(self):
        ...
        response = self.client.put(reverse("change_password", kwargs={'id': 2}), data)
    ...
    def test_change_password_passwords_do_not_match(self):
        ...
        response = self.client.put(reverse("change_password", kwargs={'id': self.user.id}), data)
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.data["password"], ["Les mots de passe ne correspondent pas"])
    ...
    def test_change_password_password_too_short(self):
        ...
        response = self.client.put(reverse("change_password", kwargs={'id': self.user.id}), data)
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.data["error"][0], "Le mot de passe doit contenir au moins 8 caractères")
    ...
    def test_change_password_no_number_in_password(self):
        ...
        response = self.client.put(reverse("change_password", kwargs={'id': self.user.id}), data)
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.data["error"][0], "Le mot de passe doit contenir au moins un chiffre")
    ...
    def test_change_password_no_special_character_in_password(self):
        ...
        response = self.client.put(reverse("change_password", kwargs={'id': self.user.id}), data)
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.data["error"][0], "Le mot de passe doit contenir au moins un caractère spécial")
    ...
    def test_change_password_no_uppercase_in_password(self):
        ...
        response = self.client.put(reverse("change_password", kwargs={'id': self.user.id}), data)
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.data["error"][0], "Le mot de passe doit contenir au moins une majuscule")
    ...
    def test_change_password_no_lowercase_in_password(self):
        ...
        response = self.client.put(reverse("change_password", kwargs={'id': self.user.id}), data)
        self.assertEqual(response.status_code, 400)
        self.assertEqual(response.data["error"][0], "Le mot de passe doit contenir au moins une minuscule")
