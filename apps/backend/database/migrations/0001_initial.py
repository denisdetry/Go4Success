# Generated by Django 5.0.3 on 2024-04-25 19:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('positive_point', models.BooleanField()),
                ('negative_point', models.BooleanField()),
                ('suggestion', models.BooleanField()),
                ('additional_comment', models.BooleanField()),
        ...
        migrations.CreateModel(
            name='FeedbackAdditionalQuestions',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('question', models.BooleanField()),
                ('feedback', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.feedback')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='FeedbackStudentAdditionalQuestions',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('answer', models.TextField(blank=True, null=True)),
                ('feedback', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.feedback')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.feedbackadditionalquestions')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
